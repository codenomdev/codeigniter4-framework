...
namespace Codenom\Framework\Config\Util;

use Codenom\Framework\Exception\Util\InvalidXmlException;
use Codenom\Framework\Exception\Util\XmlParsingException;
